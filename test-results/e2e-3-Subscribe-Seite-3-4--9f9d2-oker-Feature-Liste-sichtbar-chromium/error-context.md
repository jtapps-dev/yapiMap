...
- Name: e2e.spec.ts >> 3. Subscribe Seite >> 3.4 - Developer Feature-Liste und Broker Feature-Liste sichtbar
- Location: tests\e2e.spec.ts:385:7
...
Locator: locator('text=Developer').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Developer').first()
