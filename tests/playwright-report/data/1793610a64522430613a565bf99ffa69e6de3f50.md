...
- Name: e2e.spec.ts >> 3. Subscribe Seite >> 3.3 - PREMIUM Badge und YapiMap Premium Titel sichtbar
- Location: tests\e2e.spec.ts:374:7
...
Locator: locator('text=PREMIUM').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=PREMIUM').first()
